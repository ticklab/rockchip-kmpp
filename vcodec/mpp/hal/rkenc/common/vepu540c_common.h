...
typedef struct Vepu540cOsdCom_t {
	struct {
		RK_U32 osd_en:1;
		RK_U32 osd_yg_inv_en:1;
		RK_U32 osd_uvrb_inv_en:1;
		RK_U32 osd_alpha_inv_en:1;
		RK_U32 osd_inv_sel:1;
	...
	struct {
		...
		RK_U32 osd_uv_sw_inv_en:1;
		RK_U32 osd_inv_size:2;
		RK_U32 reserved:1;
	} cfg2;

	RK_U32 osd_st_addr;
	RK_U32 osd_inv_st_addr;

	struct {
		RK_U32 osd_stride:17;
		RK_U32 osd_inv_stride:8;
...
typedef struct Vepu540cOsdReg_t {
	/* 0x00003000 reg3072 */
	vepu540c_osd_com osd_cfg[8];
	...
	/* 0x00003130 reg3148 */
	struct {
		RK_U32 osd_inv_uvrb_min:8;
		RK_U32 osd_inv_uvrb_max:8;
		RK_U32 osd_inv_yg_min:8;
		RK_U32 osd_inv_yg_max:8;
	} whi_cfg4;

	/* 0x00003134 reg3149 */
	struct {
		RK_U32 osd_inv_alpha_min:8;
		RK_U32 osd_inv_alpha_max:8;
		RK_U32 reserved:16;
	} whi_cfg5;
} vepu540c_osd_reg;
...
typedef struct Vepu540cOsdRegs_t {
	...
	vepu540c_osd_reg osd_comb_cfg;	//used for hevc & avc
	/*0x00003138 reg3150 - 0x0000326c reg3227 */
	vepu540c_osd_reg osd_jpeg_cfg;
} vepu540c_osd_regs;
...
typedef struct Vepu540cOsdCfg_t {
	void *reg_base;
	MppDev dev;
